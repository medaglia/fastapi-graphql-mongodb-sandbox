# USA Jobs Api Fastapi-Mongodb-Docker

Just a sandbox app to test out Fastapi, Strawberry, and MongoDB (Beanie). Not for deployment.


Initial template from [here](https://github.com/jonasrenault/fastapi-react-mongodb-docker).

## Project structure

The project is composed of a backend API server built with FastAPI located in the [backend](backend) dir.

## Running the application locally for development

To run the application manually in a terminal, see the [backend](backend/README.md) for instructions.
...
* Interactive GraphQL documentation with graphiql: http://localhost/api/v1/graphql
